-- PostgreSQL Data Import for OJTracker
-- Run this in Neon SQL Editor AFTER Render deployment (migrations run first)
-- Generated from MySQL dump on March 2, 2026
...
-- Update dtr_logs sequence
SELECT setval('dtr_logs_id_seq', (SELECT MAX(id) FROM dtr_logs));
...
-- Update accomplishments sequence
SELECT setval('accomplishments_id_seq', (SELECT MAX(id) FROM accomplishments));

-- ============================================================
-- NOTIFICATIONS
-- ============================================================
INSERT INTO "notifications" ("id", "user_id", "type", "title", "message", "icon", "link", "is_read", "created_at", "updated_at") VALUES
(1, 2, 'system', '👋 Welcome to OJTracker!', 'Welcome Soydelz Dela Peña! Start tracking your OJT hours by logging your Time In/Out on the Dashboard.', '👋', 'https://ojtracker-q84t.onrender.com/dashboard', FALSE, '2026-01-15 02:58:45', '2026-01-15 02:58:45');

-- Update notifications sequence
